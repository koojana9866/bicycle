...
<!------ Include the above in your HEAD tag - 1 2 4 5 7 ---------->
<div class="container">
    <h3 class="h3">Products Example 1 </h3>
    <div class="row">
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#">
                    <img class="pic-1" src="src\Bicycle_Red_1000_0001.jpg">
                    </a>
                    <ul class="social">
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">bicycle</a></h3>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">bycicle</a></h3>
...
<div class="container">
    <h3 class="h3">Products Example 4 </h3>
    <div class="row">
        <div class="col-md-3 col-sm-6">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid4">
                <div class="product-image4">
                    <a href="#">
                        <img class="pic-1" src="src\Bicycle_Red_1000_0001.jpg">
                        <img class="pic-2" src="src\Bicycle_Red_1000_0001.jpg">
                    <ul class="social">
                        <li><a href="#" data-tip="Quick View"><i class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="#" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
